...
//		RETOURNE: la chaine de charactère qui devrait être affichée si la méthode testée est correcte
//		NOTE: L'optimization de ce test est désactivée car on ne veut pas que les objets de type 'TP1::collection'
//			soit enlevés car non utilisés.
...
//		RETOURNE: un entier nul si les chaines sont égales, négatif si le premier charactère différent
//			a une valeur inferieure dans lhs et un entier positif sinon.
...
static void test(TestFuncPtr testFunc, const char* testName = "")
{

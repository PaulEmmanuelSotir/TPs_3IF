...
import TP1_SI.metier.service.ServiceTechnique;
...
public class Services {
    ...
    public ServiceResult<Adherent, ConnexionError> Connexion(String mail) {
        try
        {
            ...
            if(adherent == null)
                return new ServiceResult(null, ConnexionError.BAD_EMAIL);
            return new ServiceResult(adherent, ConnexionError.OK);
        }
        catch(Throwable e)
        {
            return new ServiceResult(null, ConnexionError.DATABASE_ERROR);
        }
    }
    ...
    public ServiceResult<Adherent, ConnexionError> Inscription(String nom, String prenom, String mail, String adresse) {
        ...
        {
            return new ServiceResult(null, ConnexionError.WRONG_ADDRESS);
        }
    }
    ...
    public ServiceResult<List<Event>, Request_Error> ListeEventDate(Date date) {
        ...
        try
        {
            return new ServiceResult(event_dao.findByDate(date), Request_Error.OK);
        }
        catch(Throwable e)
        {
            return new ServiceResult(null, Request_Error.DATABASE_ERROR);
        }
    }
    ...
    public ServiceResult<List<Event>, Request_Error>  ListeEvent() {
        ...
        {
            EventDao event_dao = new EventDao();
            return new ServiceResult(event_dao.findAll(), Request_Error.OK);
        }
        catch(Throwable e)
        {
            return new ServiceResult(null, Request_Error.DATABASE_ERROR);
    ...
    public ServiceResult<Event , Request_Error>  CreerEvent(long adherent_id, int activite_id, Date date){
        ...
        if(activite == null)
                return new ServiceResult(null,Request_Error.WRONG_ACTIVITE_ID);
        
        AdherentDao adherent_dao = new AdherentDao();
        Adherent adherent = adherent_dao.findById(adherent_id);
        if(adherent == null)
                return new ServiceResult(null,Request_Error.WRONG_ADHERENT_ID);
        
        Event event = new Event(date, activite, adherent);
        return new ServiceResult(event, Request_Error.OK);
        }
        catch(Throwable e)
        {
            return new ServiceResult(null, Request_Error.DATABASE_ERROR);
    ...
    public ServiceResult<List<Event> , Request_Error> ListeEventAdherent(long adherent_id){
        try
        {
            ...
            return new ServiceResult (liste, Request_Error.OK) ;
        }
        catch(Throwable e)
        {
            return new ServiceResult(null, Request_Error.DATABASE_ERROR);
    ...
    public ServiceResult<List<Event> , Request_Error> ListeEventDispo(){
        ...
        {
        EventDao event_dao = new EventDao();
        return new ServiceResult(event_dao.findDispo(), Request_Error.OK);
        }
        catch(Throwable e)
        {
            return new ServiceResult(null, Request_Error.DATABASE_ERROR);
    ...
    public ServiceResult<List<Activite> , Request_Error> ListeActivite(){
        ...
        {
             ActiviteDao activite_dao = new ActiviteDao();
             return new ServiceResult(activite_dao.findAll(), Request_Error.OK) ;
        }
        catch(Throwable e)
        {
            return new ServiceResult(null, Request_Error.DATABASE_ERROR);

...
public class Navigator {
    ...
    public void showLoginPage(Socket_DAL dal) {
        ...
        try {
            ...
            loader.setLocation(Main.class.getClassLoader().getResource("Client/view/login_view.fxml"));
    ...
    public void showNewAccountPage(Socket_DAL dal) {
        ...
        try {
            // Load view
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("Client/view/newAccount_view.fxml"));
            Parent content = (Parent)loader.load();
    ...
    public void showGroupsPage(Socket_DAL dal, User user) {
        ...
        try {
            // Load view
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("Client/view/groups_view.fxml"));
            Parent content = (Parent)loader.load();
    ...
    public void showChatPage(Socket_DAL dal, User user, Group group, String[] usernames, Message[] message_history) {
        ...
        try {
            // Load view
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("Client/view/chat_view.fxml"));
            Parent content = (Parent)loader.load();
